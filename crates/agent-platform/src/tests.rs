//! Tests for platform adapters that can run without a browser.
//! Only memory-based storage and VFS tests are here.
//! IndexedDB, Shell (Worker), and LLM (fetch) tests require wasm-pack + headless browser.

#[cfg(test)]
mod tests {
    use crate::storage::MemoryStorage;
    use crate::vfs::StorageVfs;
    ...
    #[test]
    fn test_memory_storage_set_and_get() {
        let storage = MemoryStorage::new();
        block_on(async {
    ...
    #[test]
    fn test_memory_storage_delete_nonexistent() {
        let storage = MemoryStorage::new();
        block_on(async {
            // Should not error
    ...
    #[test]
    fn test_memory_storage_list_keys_empty_prefix() {
        let storage = MemoryStorage::new();
        block_on(async {
    ...
    #[test]
    fn test_memory_storage_list_keys_no_match() {
        let storage = MemoryStorage::new();
        block_on(async {
    ...
    #[test]
    fn test_memory_storage_empty_value() {
        let storage = MemoryStorage::new();
        block_on(async {
    ...
    #[test]
    fn test_memory_storage_large_data() {
        let storage = MemoryStorage::new();
        block_on(async {
